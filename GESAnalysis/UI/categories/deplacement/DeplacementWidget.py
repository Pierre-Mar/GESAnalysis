...
class DeplacementWidget(QtWidgets.QWidget, Observer):
    """ Widget use to regroup the graphs, the files opener and the stats of the category "Déplacements"
    """
    ...
    def __init__(
        ...
        super(DeplacementWidget, self).__init__(parent)
...
#######################################################################################################
    def __init_UI(self):
        ...
        # Add graph for "Deplacement" here
